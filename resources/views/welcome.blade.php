...
<div class="row" id="banners" style="margin-top:-50px;">
...
<div class="row" style="height:150px; background-color:#000; color:#fff;">
            ...
            <div class="col-sm-3">
              <div class="thumb-wrapper">
                ...
                <div class="thumb-content">
                  ...
                  <a href="#" onclick="cart_add('{{$p->id}}');" class="btn btn-primary">Agregar a Carrito <i class="fas fa-shopping-cart"></i></a>
                </div>
              </div>
            </div>
